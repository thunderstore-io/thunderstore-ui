...
// Preloaded in <head>; see the <link rel="preload"> tags there.
      ...
      <head>
        ...
        */}
        ...
        {/* The @font-face rules live in the stylesheet, so without these no font
            is discovered until it has been parsed. Only the two faces that
...
function AdsInit({ createAds }: { createAds: boolean }) {
  ...
  useEffect(() => {
    ...
    // The delay sets the floor; the idle wait only picks the moment within it.
