...
import { isStringOneOf } from "cyberstorm/utils/typeChecks";
...
const reportReasonValues = reportOptions.map((option) => option.value);
      ...
      <Modal.Body>
        <div className="report-package__block">
          ...
          <NewSelect
            ...
            onChange={(value) => {
              if (!isStringOneOf(value, reportReasonValues)) {
                console.error("Invalid report reason value:", value);
                return;
              }
