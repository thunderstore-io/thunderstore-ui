...
import type { SelectOption } from "@thunderstore/cyberstorm/src/newComponents/SelectSearch/SelectSearch";
...
export const Multiple: Story = {
  args: {},
  render: (args) => {
    const [val, setVal] = useState<SelectOption<string>[] | undefined>(
      undefined
    );
