 ...
 * and uses virtual scrolling to render the content
...
export function CodeBoxHTML({ value = "", maxHeight = 600 }: CodeBoxHTMLProps) {
  ...
  const BUFFER_LINES = 25; // Extra lines to render above/below viewport, so that there's content to render immediately when scrolling, making it smoother
