...
/**
 * Domain-specific error surfaced to UI layers with safe messaging and optional context.
 */
...
/**
 * Formats a `UserFacingError` into a sentence suitable for toast or alert copy.
 */
...
/**
 * Maps diverse API/transport errors into the `UserFacingError` abstraction.
 */
